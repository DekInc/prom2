...
<head>
	...
	<title>Reporte de despedidos, suspendidos y activos</title>
</head>
<body>
			...
			<div class="card-deck cardMain">
				<div class="card box-shadow">
					<div class="card-header">
						<h4 class="my-0 font-weight-normal">Reporte de despedidos, suspendidos y activos</h4>
					</div>
					<div class="card-body">						
	...
	<script>		
		...
		async function crearGrid() {
			...
			console.log(listTrabajadores);
			let contador = 0;
			for(let i =0; i<listTrabajadores.length;i++){
				if(listTrabajadores[i].Activo===false){
					despedidos++;
				} else if (listTrabajadores[i].Suspendido===true){
					suspendidos++;
				} else {
					activos++;
				}
			...
			gridRep1 = $('#gridRep1').w2grid({
				...
				records: [
					{ recid: 1, tipo: 'Despedidos', valor: despedidos},
					{ recid: 2, tipo: 'Suspendidos', valor: suspendidos},
					{ recid: 3, tipo: 'Activos', valor: activos}
				]
			});
